                ...
                items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-primary font-semibold mt-0.5">৳{item.product.price.toLocaleString()}</p>
            ...
            {items.length > 0 && (
              <div className="p-4 sm:p-6 border-t border-border space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-display font-bold text-foreground text-base">৳{subtotal.toLocaleString()}</span>
                </div>
                <Link
                  to="/cart"
                  onClick={onClose}

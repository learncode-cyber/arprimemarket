...
export const socialLinks = [
  ...
  { icon: MessageCircle, href: "https://web.whatsapp.com/send?phone=8801910521565", label: "WhatsApp", color: "hover:bg-[#25D366] hover:text-white" },
...
export const ShareButtons = ({ url, title, className = "" }: ShareButtonsProps) => {
  ...
  const shareLinks = [
    ...
    { icon: MessageCircle, href: `https://wa.me/?text=${encodedTitle}%20${encodedUrl}`, label: "WhatsApp", bg: "hover:bg-[#25D366] hover:text-white" },

...
export const CustomerReviews = () => (
  <section className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
    ...
    >
      <h2 className="font-display text-lg sm:text-2xl font-bold text-foreground">What Our Customers Say</h2>
      <p className="text-xs text-muted-foreground mt-1">Real reviews from real customers</p>
    </motion.div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
      {reviews.map((r, i) => (
        <motion.div
          ...
          className="p-4 sm:p-5 rounded-2xl bg-card border border-border relative"
        >
